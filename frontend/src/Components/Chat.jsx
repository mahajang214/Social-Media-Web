  ...
  return (
    <div className="w-full h-full flex flex-col">
      ...
      <div className="w-full relative h-[90%] p-4 overflow-y-scroll overflow-x-hidden border-b-[1px]">
        ...
        {loading && <Loading />}
        {menuAnime&&<motion.div initial={{
          x:500
        }} 
        animate={{
          x:0
        }}
        transition={{duration:.5}} className="absolute backdrop-blur-xs cursor-context-menu top-0 right-0 w-[30vh] h-full bg-[#00acb5d9] ">
        <button id="mbtn" className="w-full py-2 text-2xl flex justify-center items-center  bg-[#ffffff31] rounded-xl mt-5 cursor-pointer ">
        <svg
            width="30px"
            height="30px"
            viewBox="0 0 20 17"
          ...
          <button id="mbtn" className="w-full py-2 text-2xl flex justify-center   bg-[#ffffff31] rounded-xl mt-5 cursor-pointer ">
          <svg width="30px" height="30px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" xmlSpace="preserve" xmlnsserif="http://www.serif.com/" stroke="#000" strokeWidth={'.5px'}  fill="#fff"
